...
use flowpact_protocol::{AckStatus, Capabilities, ChunkRange, Command, Parser, Response, FLOWPACT_VERSION};
...
impl ClientConnection {
    ...
    pub async fn hello(&mut self) -> Result<Response> {
        let cmd = Command::hello(FLOWPACT_VERSION, Capabilities::all());
